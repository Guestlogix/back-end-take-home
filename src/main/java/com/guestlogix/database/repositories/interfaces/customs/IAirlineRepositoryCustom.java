...
/**
 * An interface that defines which methods any Airline repository will have to implement. This interface exists for the sole purpose of custom methods creation.
 *
